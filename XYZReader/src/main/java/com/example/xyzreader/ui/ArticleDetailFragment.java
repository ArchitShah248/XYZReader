...
//            appBarDetail.setTitle(title);


//            titleView.setText(title);
            collapsingToolbarLayout.setTitle(title);

            Spanned bylineStr = Html.fromHtml(
...
//                        }
//                    });
            Glide.with(getActivity()).load(mCursor.getString(ArticleLoader.Query.PHOTO_URL)).centerCrop().placeholder(R.drawable.empty_detail).crossFade().into(mPhotoView);
